...
class Create_wrfinput(object):
    def __init__(self):
        ...
        self.description = "This tool was developed for the purpose of creating wrfinput files for " + \
                            ...
                            "This tool takes an input GEOGRID (geo_em.d0*.nc) file, " + \
                            "typically created by the WPS geogrid.exe program, " + \
                            "and a start month (January=1, December=12) to build " + \
    ...
    def getParameterInfo(self):
        ...
        # Input parameter
        in_nc = arcpy.Parameter(
            displayName="Input GEOGRID file, defining the model domain of interest generated by the WRF Preprocessing System (WPS)",
            name="in_nc",
            datatype="File",
            parameterType="Required",
            direction="Input")
        ...
        out_file = arcpy.Parameter(
            displayName="Output file, wrfinput_d01.nc (default filename). This file is used to initialize the Noah-MP land surface model in WRF-Hydro",
            name="out_file",
            datatype="File",
            parameterType="Required",
            direction="Output")
        out_file.value = 'wrfinput_d01.nc'
